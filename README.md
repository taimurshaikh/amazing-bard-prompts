...
- English guide <br>
After forking this repository, inspect the bard_prompts_english csv file to see if the prompt works normally.
A markdown file is automatically generated based on the content of the CSV file, and multiple contributors may be involved.
...
- 한국어 가이드 <br>
본 레포지토리를 포크하신 뒤, bard_prompts_korean.csv 파일에서 프롬프트가 정상적으로 작동하는지 검수하세요. <br>
CSV 파일의 내용을 바탕으로 markdown파일은 자동으로 생성되며, 기여자는 여러명이될 수 있습니다. 
