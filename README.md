...
- [Amazing-Bard-Prompts](https://github.com/dsdanielpark/amazing-bard-prompts)의 초기 버전은 구글 엔진으로 번역만 되어있습니다. 본 레포지토리를 포크하신 뒤, 프롬프트를 검수하시거나, 수정/삭제하신 다음에 마련되어있는 기여자란에 본인의 아이디와 깃 허브 링크를 작성하셔서 Pull Request해주세요. 본 레포지토리의 기여자가 되실 수 있습니다.
